...
const repositories = [
  ...
  {
    key: "X meta-llama/llama3 ollama/ollama langchain-ai/langchain microsoft/autogen openai/openai-cookbook elastic/elasticsearch milvus-io/pymilvus",
    value: "Number of stars",
  },
  {
    key: "Y meta-llama/llama3 ollama/ollama langchain-ai/langchain microsoft/autogen openai/openai-cookbook elastic/elasticsearch milvus-io/pymilvus",
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading ? (
          ...
          <div>
            ...
            {flag && <BarCharts
              title={`Monthly Created Issues of ${repository.value} in last 2 months`}
              data={githubRepoData?.created}
            />}

            {/* Render barchart component for weekly closed issues for a selected repositories*/}
            {flag && <BarCharts
              title={`Weekly Closed Issues of ${repository.value} in last 2 months`}
